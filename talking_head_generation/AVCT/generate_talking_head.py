...
def test_with_input_audio_and_image(img_path, audio_path,phs, generator_ckpt, audio2pose_ckpt, save_dir="samples/results"):
    with open("talking_head_generation/AVCT/config_file/vox-256.yaml") as f:
    ...
    opt = argparse.Namespace(**yaml.safe_load(open("talking_head_generation/AVCT/config_file/audio2kp.yaml")))
